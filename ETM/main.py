...
## get data
# 1. vocabulary
vocab, training_set, valid, test_1, test_2 = data.get_data(doc_terms_file_name=args.data_path+"tf_idf_doc_terms_matrix_time_window_1",
                                                           terms_filename=args.data_path+"tf_idf_terms_time_window_1")
...
if not args.train_embeddings:
    embeddings = data.read_embedding_matrix(vocab, device, embeddings_path=args.emb_path)#, load_trainned=False)
...
if args.mode == 'train':
    ...
    with torch.no_grad():
        ...
        if args.train_embeddings:
            ...
            queries = ['CAV2','IGHJ6','MRS2','PRKAR1B','FAM132A','HUS1','HAAO','MSS51','MRPL53','MRPS9','KCNT1']
            print('\n')
            print('ETM embeddings...')
            for word in queries:
                print('word: {} .. etm neighbors: {}'.format(word, nearest_neighbors(embeddings,word)))
            print('\n')
